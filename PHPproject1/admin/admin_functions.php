...
if (isset($_POST['create_admin'])) {
        createAdmin($conn, $_POST);
}
// if user clicks the Edit admin button
if (isset($_GET['edit-admin'])) {
        $isEditingUser = true;
        $admin_id = $_GET['edit-admin'];
        editAdmin($conn, $admin_id);
}
// if user clicks the update admin button
if (isset($_POST['update_admin'])) {
        updateAdmin($conn, $_POST);
}
...
* * * * * * * * * * * * * * * * * * * * * * */
function createAdmin($conn, $request_values){
    global $errors, $role, $username, $email;
    $username = esc($conn, $request_values['username']);
    $email = esc($conn, $request_values['email']);
    $password = esc($conn, $request_values['password']);
    $passwordConfirmation = esc($conn, $request_values['passwordConfirmation']);

    if(isset($request_values['role'])){
            $role = esc($conn, $request_values['role']);
    }
...
function createTopic($conn, $request_values){
    global $errors, $topic_name;
    $topic_name = esc($conn, $request_values['topic_name']);
...
* * * * * * * * * * * * * * * * * * * * * */
function editAdmin($conn, $admin_id)
{
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
function updateAdmin($conn, $request_values){
...
* * * * * * * * * * * * * * * * * * * * * */
function editTopic($conn, $topic_id) {
...
function updateTopic($conn, $request_values) {
